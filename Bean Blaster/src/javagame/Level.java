...
public class Level
{
    ...
    private void addWalls(int x, int y, int texturex, int texturey)
    {
        ...
        world.add(new Mesh(new Vector3f[]
                ...
                new Vector2f[]
                {
                    new Vector2f(ImageLoader.getTextureWidthPosition(4), ImageLoader.getTextureHeightPosition(3)),
                    new Vector2f(ImageLoader.getTextureWidthPosition(5), ImageLoader.getTextureHeightPosition(3)),
                    new Vector2f(ImageLoader.getTextureWidthPosition(5), ImageLoader.getTextureHeightPosition(4)),
                    new Vector2f(ImageLoader.getTextureWidthPosition(4), ImageLoader.getTextureHeightPosition(4))
                }));
